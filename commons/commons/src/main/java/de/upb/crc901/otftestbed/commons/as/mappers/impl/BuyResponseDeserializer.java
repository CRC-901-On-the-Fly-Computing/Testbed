...
public class BuyResponseDeserializer extends StdDeserializer<BuyResponse>{
	...
	public BuyResponseDeserializer() {
		super(BuyResponse.class);
	}


	@Override
	public BuyResponse deserialize(JsonParser p, DeserializationContext ctxt)
