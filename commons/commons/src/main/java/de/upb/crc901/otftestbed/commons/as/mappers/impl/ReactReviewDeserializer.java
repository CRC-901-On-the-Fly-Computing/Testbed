...
public class ReactReviewDeserializer extends StdDeserializer<ReactReview>{
	...
	public ReactReviewDeserializer() {
		super(ReactReview.class);
	}


	@Override
	public ReactReview deserialize(JsonParser p, DeserializationContext ctxt)
