...
public class SearchableSignedReputationDeserializer extends StdDeserializer<SearchableSignedReputation>{
	...
	public SearchableSignedReputationDeserializer() {
		super(SearchableSignedReputation.class);
	}


	@Override
	public SearchableSignedReputation deserialize(JsonParser p, DeserializationContext ctxt)
		...
		return new SearchableSignedReputation (repr);
	}
