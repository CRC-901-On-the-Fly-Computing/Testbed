...
public class OutputParam implements Serializable {
     ...
     * 
     */
	@ApiModelProperty(position =0, example="b", required = true)
    @JsonProperty("name")
    private String name;
    /**
     * 
     ...
     * 
     */
	@ApiModelProperty(position =1, example="http://crc901.upb.de/MLTerms#boolean", required = true)
    @JsonProperty("dataType")
    private String dataType;
    @JsonIgnore
    private final Map<String, Object> additionalProperties = new HashMap<String, Object>();
    private final static long serialVersionUID = -1703499120436051683L;
    ...
    public boolean equals(final Object other) {
        ...
        if ((other instanceof OutputParam) == false) {
            return false;
        }
        final OutputParam rhs = ((OutputParam) other);
